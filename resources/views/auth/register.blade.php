        ...
        <div class="w-full min-h-screen flex flex-col items-center justify-center py-[46px] px-4 gap-8">
            ...
            <form action="{{ route('register') }}" method="POST"
                ...
                <div class="flex flex-col gap-1 text-center">
                    ...
                    <p class="text-sm leading-[25px] tracking-[0.6px] text-darkGrey">Enter valid data to create your
                        account</p>
                </div>
                            ...
                            <button type="button" id="upload-file" class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div id="file-info" class="flex-row items-center hidden gap-3 flex-nowrap">
                                        <span id="fileName"
                                            class="text-sm tracking-035 leading-[22px] text-nowrap"></span>
                                    </div>
                                </div>
                ...
                <p class="text-sm text-center tracking-035 text-darkGrey">Already have account? <a
                        href="{{ route('login') }}" class="text-[#4D73FF] font-semibold tracking-[0.6px]">Sign In</a>
                </p>
            </form>
        </div>
    </section>
